...
model_params = {
    ...
    "mortality_chance": mesa.visualization.Slider(
        ...
        value=1e-1, min_value=0, max_value=1, step=0.05,
    ),
}
...
server = mesa.visualization.ModularServer(
    Cholera, [chart, get_removed_people, get_infectious_pumps], model_params=model_params
)
